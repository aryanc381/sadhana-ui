...
export function ChartAreaInteractive({ goalName }: { dateRange?: DateRange; goalName: string | undefined }) {
  ...
  React.useEffect(() => {
    ...
    getEvaluationProgress(format(from, "yyyy-MM-dd"), format(to, "yyyy-MM-dd"))
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="h-[300px] w-full">
          <AreaChart data={data}>
            ...
            <Area dataKey="total_tasks" type="monotone" stroke="var(--color-total_tasks)" fill="none" strokeWidth={2} />
