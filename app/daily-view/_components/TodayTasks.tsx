...
export function TodayTasks({ ticket, skills, onChange, onShortcut }: { ticket: DailyTicket; skills: Skill[]; onChange: (ticket: DailyTicket) => void; onShortcut?: (openTask: () => void) => void }) {
  ...
  return (
    <Card className="min-w-0">
      <CardHeader className="flex-row items-center justify-between"><CardTitle>Today’s tasks</CardTitle><Button variant="outline" onClick={startTask} className="cursor-pointer">Add task <span className="text-muted-foreground">⌘ D</span></Button></CardHeader>
